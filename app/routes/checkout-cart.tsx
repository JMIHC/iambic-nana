...
import type { Route } from "./+types/checkout-cart";
...
export default function CheckoutCart() {
  ...
  const handleCheckout = async () => {
    ...
    if (orderNotes) {
      window.sessionStorage.setItem('orderNotes', orderNotes);
    }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-8">Review Your Cart</h1>
